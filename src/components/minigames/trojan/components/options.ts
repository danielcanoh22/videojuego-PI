import { Enemy } from "@/types/trojan";
...
export const ansOption: Question[] = [
  {
    id: 1,
    question:
      "Estás en una cafetería y necesitas usar el WiFi público para revisar un correo urgente del trabajo. ¿Qué deberías hacer para proteger tu información?",
    options: [
  ...
  },
  {
    id: 2,
    question:
      "Recibes un correo de tu banco solicitándote confirmar tus datos personales haciendo clic en un enlace. ¿Qué harías?",
    options: [
  ...
  },
  {
    id: 3,
    question:
      "Ves una oferta increíble en línea, pero el sitio web no tiene 'https' en la URL. ¿Cómo procederías?",
    options: [
  ...
  },
  {
    id: 4,
    question:
      "Estás descargando una aplicación gratuita y te pide acceso a tus fotos, contactos y ubicación. ¿Qué harías?",
    options: [
  ...
  },
  {
    id: 5,
    question:
      "Un amigo te pide que le envíes tu contraseña para revisar algo en tu cuenta desde su dispositivo. ¿Cuál es la mejor respuesta?",
    options: [
  ...
  },
  {
    id: 6,
    question:
      "Recibes un archivo adjunto en un correo desconocido con el título 'Factura pendiente'. ¿Qué deberías hacer?",
    options: [
  ...
  },
  {
    id: 7,
    question:
      "Encuentras una memoria USB en el estacionamiento de tu oficina. ¿Qué haces con ella?",
    options: [
  ...
  },
  {
    id: 8,
    question:
      "Tu jefe te pide que compartas datos confidenciales por mensaje de texto. ¿Qué deberías hacer?",
    options: [
  ...
  },
  {
    id: 9,
    question:
      "Quieres proteger tus cuentas en redes sociales. ¿Cuál de las siguientes es la mejor práctica?",
    options: [
  ...
  },
  {
    id: 10,
    question:
      "Notas actividad inusual en tu cuenta bancaria en línea. ¿Qué deberías hacer primero?",
    options: [
  ...
  },
  {
    id: 11,
    question:
      "Alguien te envía un mensaje pidiéndote que descargues una 'herramienta de seguridad' para proteger tu computadora. ¿Qué haces?",
    options: [
  ...
  },
  {
    id: 12,
    question:
      "Te llega una notificación de que alguien ha intentado acceder a tu cuenta desde otro país. ¿Qué haces?",
    options: [
  ...
  },
  {
    id: 13,
    question:
      "Al navegar en internet, encuentras un anuncio que ofrece descargar software caro de forma gratuita. ¿Qué deberías hacer?",
    options: [
